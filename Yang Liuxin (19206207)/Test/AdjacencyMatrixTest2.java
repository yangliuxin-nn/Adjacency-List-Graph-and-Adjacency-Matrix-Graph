 ...
 *
 * The graph is composed of three connected components.
 *
 */

public class AdjacencyMatrixTest2 {
    public static void main(String[] args) {
        IGraph<Integer,Integer> g = new AdjacencyMatrixGraph<>();

        // create some 13 vertices in total
        ...
        // test insert vertex
        // previous vertices: vertices1
        IIterator vertices1 = g.vertices();
        int count1 = ((AdjacencyMatrixGraph) g).printIterator(vertices1);
        System.out.println();
        System.out.println("The number of vertices previously: " + count1);
        // insert a new vertex: v13
        IVertex<Integer> v13 = g.insertVertex(13);
        // new vertices: vertices2
        IIterator vertices2 = g.vertices();
        int count2 = ((AdjacencyMatrixGraph) g).printIterator(vertices2);
        System.out.println();
        ...
        // test insert edge
        // previous edges: edges1
        IIterator edges1 = g.edges();
        // the number of previous edges: num3
        int count3 = ((AdjacencyMatrixGraph) g).printIterator(edges1);
        System.out.println();
        System.out.println("The number of vertices previously: " + count3);
        // insert a new edge: e14
        IEdge<Integer> e14 = g.insertEdge( v12, v13, 1213 );
        // new edges: edges2
        IIterator edges2 = g.edges();
        // the number of new edges: num4
        int count4 = ((AdjacencyMatrixGraph) g).printIterator(edges2);
        System.out.println();
        ...
        // previous incidentEdges: incident0
        IIterator incident0 = g.incidentEdges(v0);
        // the number of previous incidentEdges: numIn1
        int numIn1 = ((AdjacencyMatrixGraph) g).printIterator(incident0);
        System.out.println();
        System.out.println("The number of incident edges of v0: " + numIn1);
        g.removeVertex(v5);
        // new incidentEdges: incident1
        IIterator incident1 = g.incidentEdges(v0);
        // the number of previous incidentEdges: numIn2
        int numIn2 = ((AdjacencyMatrixGraph) g).printIterator(incident1);
        System.out.println();
        ...
        System.out.println("Test incident edges: " + ((AdjacencyMatrixGraph) g).testEqual(incidentV12, correctIn));
        ...
        System.out.println("Test vertices: " + ((AdjacencyMatrixGraph) g).testEqual(vertices, correctVer));
        ...
        System.out.println("Test edges: " + ((AdjacencyMatrixGraph) g).testEqual(edges, correctEdges));
        ...
        // test the matrix
        IEdge[][] correctMatrix = new IEdge[][]{
                {null, e2, e3, null, null, e4, null, null, null, null, null, null, null},
                {e2, null, null, null, null, null, null, null, null, null, null, null, null},
                {e3, null, null, null, null, null, null, null, null, null, null, null, null},
                {null, null, null, null, null, null, null, null, null, null, null, null, null},
                {null, null, null, null, null, e8, null, null, null, null, null, null, null},
                {e4, null, null, null, e8, null, null, null, null, null, null, null, null},
                {null, null, null, null, null, null, null, e9, null, null, null, null, null},
                {null, null, null, null, null, null, e9, null, null, null, null, null, null},
                {null, null, null, null, null, null, null, null, null, e11, e10, e12, null},
                {null, null, null, null, null, null, null, null, e11, null, null, null, null},
                {null, null, null, null, null, null, null, null, e10, null, null, e13, null},
                {null, null, null, null, null, null, null, null, e12, null, e13, null, e14},
                {null, null, null, null, null, null, null, null, null, null, null, e14, null}
        };
        System.out.print("Is the matrix correct: ");
        System.out.println(graph.testMatrix(((AdjacencyMatrixGraph<Integer, Integer>) g).getMatrix(), correctMatrix));
